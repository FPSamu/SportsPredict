...
// frontend-scripts/dashboard-script.js
// (Asegúrate de tener firebaseConfig, BACKEND_URL, loginPage y la inicialización de 'auth' arriba)
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100 bg-dark text-light shadow-sm hover-card">
                    <div class="pt-2 ps-3 d-flex justify-content-between align-items-center">
                        ...
                        <small class="pe-3 text-muted small">${timeLabel}</small>
                    </div>
                    <div class="card-body">
